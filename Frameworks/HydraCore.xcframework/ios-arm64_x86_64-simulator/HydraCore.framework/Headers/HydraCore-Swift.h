...
#ifndef HYDRACORE_SWIFT_H
#define HYDRACORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HydraCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface Event (SWIFT_EXTENSION(HydraCore))
...
/// <#Description#>
SWIFT_CLASS("_TtC9HydraCore10HydraError")
@interface HydraError : NSError
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
/// Returns an HydraError object initialized for a given domain and code with a given userInfo dictionary.
...
SWIFT_CLASS_NAMED("HydraLog")
@interface HydraLog : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end



@interface HydraLog (SWIFT_EXTENSION(HydraCore))
...
SWIFT_CLASS_NAMED("HydraNotification")
@interface HydraNotification : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end



@interface HydraNotification (SWIFT_EXTENSION(HydraCore))
@property (nonatomic, copy) NSString * _Nullable campaignId;
@property (nonatomic, copy) NSString * _Nullable body;
@property (nonatomic, copy) NSString * _Nonnull cuid;
@property (nonatomic, copy) NSData * _Nullable custom;
@property (nonatomic, copy) NSString * _Nullable type;
@property (nonatomic, copy) NSString * _Nullable gateway;
@property (nonatomic, copy) NSString * _Nullable priority;
@property (nonatomic, copy) NSString * _Nullable validity;
@property (nonatomic, copy) NSString * _Nullable expandableDetails;
@property (nonatomic, copy) NSString * _Nonnull scope;
@property (nonatomic, copy) NSString * _Nullable senderID;
@property (nonatomic, copy) NSString * _Nullable senderSource;
@property (nonatomic, copy) NSString * _Nullable variationId;
@property (nonatomic, copy) NSDate * _Nonnull createdAt;
@property (nonatomic, copy) NSString * _Nonnull isRead;
@property (nonatomic, copy) NSString * _Nonnull messageId;
@property (nonatomic, copy) NSString * _Nonnull imageIdentifier;
@property (nonatomic, copy) NSString * _Nonnull accountId;
@end


SWIFT_CLASS("_TtC9HydraCore13HydraResponse")
@interface HydraResponse : NSObject
...
SWIFT_CLASS("_TtC9HydraCore22StringValueTransformer")
@interface StringValueTransformer : NSValueTransformer
